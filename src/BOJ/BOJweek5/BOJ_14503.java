				...
				for (int h = 0; h < 4; h++) {
					...
					if (nx >= 0 && ny >= 0 && nx <= n - 1 && ny <= m - 1) {
						...
						if (map[nx][ny] == 0 && !check[nx][ny]) { // a
							...
							break;
						} else if (h == 3 && (check[nx][ny] || map[nx][ny] == 1)) { // 4���� �� û��
							if (map[xxx][yyy] == 0) {
				...
				for (int h = 1; h < 5; h++) {
					...
					if (nx >= 0 && ny >= 0 && nx <= n - 1 && ny <= m - 1) {
						...
						if (map[nx][ny] == 0 && !check[nx][ny]) { // a
							...
							q.add(new point(nx, ny, h + 1));
							break;
						} else if (h == 4 && (check[nx][ny] || map[nx][ny] == 1)) { // 4���� �� û��
							if (map[xxx][yyy] == 0) {
								q.add(new point(xxx, yyy, now.z));
								break;
							} else {
				...
				for (int h = 2; h < 6; h++) {
					...
					if (nx >= 0 && ny >= 0 && nx <= n - 1 && ny <= m - 1) {
						...
						if (map[nx][ny] == 0 && !check[nx][ny]) { // a
							...
							q.add(new point(nx, ny, h + 1));
							break;
						} else if (h == 5 && (check[nx][ny] || map[nx][ny] == 1)) { // 4���� �� û��
							if (map[xxx][yyy] == 0) {
								q.add(new point(xxx, yyy, now.z));
								break;
							} else {
				...
				for (int h = 3; h < 7; h++) {
					...
					if (nx >= 0 && ny >= 0 && nx <= n - 1 && ny <= m - 1) {
						...
						if (map[nx][ny] == 0 && !check[nx][ny]) { // a
							...
							q.add(new point(nx, ny, h + 1));
							break;
						} else if (h == 6 && (check[nx][ny] || map[nx][ny] == 1)) { // 4���� �� û��
							if (map[xxx][yyy] == 0) {
								q.add(new point(xxx, yyy, now.z));
								break;
							} else {
